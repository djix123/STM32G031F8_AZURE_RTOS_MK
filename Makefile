##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.15.2] date: [Sat Jan 01 19:04:02 EST 2022]
##########################################################################################################################
...
# target
######################################
TARGET = STM32G031F8_AZURE_RTOS_MK
...
# ASM sources
ASM_SOURCES = \
 STM32CubeIDE/Application/Startup/startup_stm32g031xx.s
...
# AS includes
AS_INCLUDES =  \
-ISTM32CubeIDE/Application/Startup
...
-IMiddlewares/ST/threadx/ports/cortex_m0/gnu/inc
...
#######################################
# link script
LDSCRIPT = ./STM32CubeIDE/STM32G031F8Px_FLASH.ld
